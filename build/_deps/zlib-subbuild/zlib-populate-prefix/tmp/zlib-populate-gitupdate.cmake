...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref "2.0.6"
  WORKING_DIRECTORY "/Volumes/SSD/Git/RGAL/src/include/extlibs/cpr-master/deps/zlib"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Volumes/SSD/Git/RGAL/src/include/extlibs/cpr-master/deps/zlib'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: '/Volumes/SSD/Git/RGAL/src/include/extlibs/cpr-master/deps/zlib'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
